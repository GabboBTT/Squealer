...
function App() {
  ...
  <Router>
    ...
    <div style={{backgroundColor: '#eee', color: '#000000DE', height: '100vh', display: 'flex', flexDirection: 'column'}}>
	    ...
	    <div style={{width:'100%', height:'100%', position:'absolute', top:'0', left:'0', zIndex:'1006', display:'none', backgroundColor:'black', opacity:'0.2'}}></div>
            ...
            {entered && windowSize >= 1024 && (<div style = {{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
              {photoProfile !== '' ? (
              ...
              {entered && windowSize >= 1024 && (<div className="text-center">
            ...
            {!entered && (<div className={windowSize >= 600 ? 'd-flex flex-column' : 'd-flex flex-row'} style={{alignItems:'center', justifyContent:'space-around', flex: windowSize >= 1024 ? '0' : '1', width:'100%'}}>
              ...
              {windowSize < 1024 && (<Nav.Item className='mb-2 d-flex' style={{borderRadius:'12px',cursor:'pointer',transition:'0.4s', width: windowSize < 600 ? '100%' : '80%', position:'relative', justifyContent:'center'}}>
                <Button onClick={goToAccess} style={{ display: 'flex', justifyContent: 'center', backgroundColor:'transparent', border:'0'}}><PersonPlus alt="access" size="25" className='mt-1' style={{color: '#000000DE'}}/></Button>
              </Nav.Item>)}
            </div>)}
